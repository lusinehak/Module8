...
public class EmailActionsPage extends GMailAbstractPage {
    ...
    public EmailActionsPage(WebDriver driver) {
        super(driver);
    }
    ...
    public EmailActionsPage composeAndSaveAsDraft(String receiver, String sbj, String cnt) {
        ...
        closeItem.click();
        return new EmailActionsPage(driver);
    }

    public EmailActionsPage goToFolder(String name) {
    ...
    public EmailActionsPage sendMail() {
        sendEmail.click();
        return new EmailActionsPage(driver);
    }
